 ...
 */
public class pugBoss extends Creature {
	 ...
	 * @param deadRight
	 */
	public pugBoss(Animation left, Animation right, Animation deadLeft, Animation deadRight) 
	{
		...
		this.jumpSpeed = -0.95f;
		this.trackPlayer=true;
		
		health = 7;
		
		//Make pugBoss intelligent
		intelligent = true;
	}
